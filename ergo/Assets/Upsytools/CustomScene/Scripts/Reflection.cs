...
using UnityEngine;
    ...
    public static class Reflection
    {
        ...
        {
            return type.GetFields(BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly|BindingFlags.Static).
                Where(f => IsSerializable(f)).ToArray();
        }

        public static FieldInfo GetSerializableField(this Type type,string fieldName)
        {
            FieldInfo fieldInfo = type.GetField(fieldName,
                BindingFlags.NonPublic | BindingFlags.Public | BindingFlags.Instance | BindingFlags.DeclaredOnly);
            if (IsSerializable(fieldInfo)) return fieldInfo;
            return null;
        }
